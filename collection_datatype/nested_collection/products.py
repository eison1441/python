...
# print mobile titles
titles=[m.get("title")for m in products]
print(titles)

# print samsung mobiles
sam=[m.get("title") for m in products if m.get("brand")=="samsung"]

print(sam)

# cheapst_price
cheapst_price=min(products,key=lambda m:m.get("price"))
print("cheapst mobile =",cheapst_price.get("title"))

expensive_price=max(products,key=lambda m:m.get("price"))
print("expensive mobile =",expensive_price.get("title"))

costly_mobile=max(products,key=lambda m:m.get("price"))
...
samsung_count=[m.get("title") for m in products if m.get("brand")=="samsung"]
print(len(samsung_count))
